...
For detailed instructions, please refer to: [reference/IMPLEMENTATION_DETAILS.md](MAINTAINER_ARCHITECTURE.md)’s message processing chapter, and [HYBRID_ARCHITECTURE.md](./HYBRID_ARCHITECTURE.md)’s callback division of labor instructions.
...
For detailed instructions, please refer to: Persistent storage chapter in [reference/IMPLEMENTATION_DETAILS.md](MAINTAINER_ARCHITECTURE.md).
...
**Regression Verification**: After the tim2tox interface is updated, scenarios such as friend application list, session list update, file transfer, etc. need to be verified. For details, see [reference/IMPLEMENTATION_DETAILS.md - Tim2tox interface compatibility and regression verification](MAINTAINER_ARCHITECTURE.md#tim2tox-interface-compatibility-and-regression-verification).

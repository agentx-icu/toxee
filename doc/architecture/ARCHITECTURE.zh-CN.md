...
详细说明请参考：[reference/IMPLEMENTATION_DETAILS.md](MAINTAINER_ARCHITECTURE.md) 的消息处理章节，以及 [HYBRID_ARCHITECTURE.md](HYBRID_ARCHITECTURE.md) 的回调分工说明。
...
详细说明请参考：[reference/IMPLEMENTATION_DETAILS.md](MAINTAINER_ARCHITECTURE.md) 中的持久化存储章节。
...
**回归验证**：tim2tox 接口更新后，需验证好友申请列表、会话列表更新、文件传输等场景。详见 [reference/IMPLEMENTATION_DETAILS.md - Tim2tox 接口兼容性与回归验证](MAINTAINER_ARCHITECTURE.md#tim2tox-接口兼容性与回归验证)。

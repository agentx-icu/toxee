[简体中文](./MOBILE_BACKGROUND.zh-CN.md)

# Mobile background, calls, and the PushKit limitation

> Generated 2026-05-20. Sibling: `doc/architecture/HYBRID_ARCHITECTURE.md`.
...
- **Keep the app in the recents stack** (don't force-quit). The OS is much
  ...
  swiped away.
- **Pair multiple devices** (see `doc/architecture/HYBRID_ARCHITECTURE.md`

[简体中文](./MAINTAINER_ARCHITECTURE.zh-CN.md)
...
| **Change risk** | High. HomePage is the post-session init hub; order must match [HYBRID_ARCHITECTURE.md](HYBRID_ARCHITECTURE.md); changes need doc and regression tests. |
...
- **LAN Bootstrap / IRC**: Settings etc.; LanBootstrapServiceManager, IrcAppManager; see [reference/CALLING_AND_EXTENSIONS.md](../reference/CALLING_AND_EXTENSIONS.md).
...
- [HYBRID_ARCHITECTURE.md](HYBRID_ARCHITECTURE.md) — Hybrid flow and callback split
- [ARCHITECTURE.md](ARCHITECTURE.md) — Overall architecture and data flow
- [reference/ACCOUNT_AND_SESSION.md](../reference/ACCOUNT_AND_SESSION.md) — Account and session lifecycle
- [reference/IMPLEMENTATION_DETAILS.md](MAINTAINER_ARCHITECTURE.md) — Implementation details and message/event handling
- [Tim2Tox](https://github.com/agentx-icu/tim2tox) [architecture](../../third_party/tim2tox/doc/architecture/ARCHITECTURE.md) — Compatibility layer and dual path
